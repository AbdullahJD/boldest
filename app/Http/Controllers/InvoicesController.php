...
class InvoicesController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if ($request->hasFile('pic')) {
            ...
            //     ['pic.mimes' => 'خطأ :تم حفظ الفاتورة ولم يتم حفظ المرفق لا بد ان يكون بي دي اف']
            // );
        ...
        $user = User::get();       // هذا لكي يرسل اشعارات الى كل المستخدمين
        // $user = User::find(Auth::user()->id); // هذا عندما تعمل فاتورة يرسل اشعار الى صاحب الفاتورة فقط
